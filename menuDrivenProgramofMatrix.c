...
int main(){
    ...
    while(1){
        printf("\nEnter 1 for operations(upper/lower triangular matrix or transpose of matrix) which require 1 matrix:\n");
        printf("Enter 2 for operations(addition, subtraction or multiplication of matrix) which require 2 matrix:\nEnter 0 to exit:\n");
        scanf("%d",&choice);
        if(choice==1){
